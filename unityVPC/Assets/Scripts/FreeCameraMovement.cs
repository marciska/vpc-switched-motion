...
public class FreeCameraMovement : MonoBehaviour
{
    ...
    void Update()
    {
        // Only move camera if it has tag "main-camera" and is currently shown on screeen
        if (!Camera.main) { return; }
        if (!GameObject.ReferenceEquals(Camera.main.gameObject, this.gameObject)) { return; }
